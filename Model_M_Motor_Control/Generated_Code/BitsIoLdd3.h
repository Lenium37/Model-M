...
#define BitsIoLdd3_MODULE_BASE_ADDRESS FPTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORTCONTROL_BASE_ADDRESS PORTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORT_MASK 0x10U     /*!< Mask of the allocated pin from the port */
#define BitsIoLdd3_PIN_ALLOC_0_MASK 0x10 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd3_PIN_ALLOC_0_INDEX 4U /*!< The index of the first allocated pin from the port */
